...
def make_optimizer_class(cls):
    class DPOptimizerClass(cls):
        def __init__(self, l2_norm_clip, noise_multiplier, minibatch_size, microbatch_size, nonprivate=False, *args, **kwargs):
                ...
                for param, accum_grad in zip(group['params'], group['accum_grads']):
                    if param.requires_grad:
                        ...
                        if not self.nonprivate:
                            ...
                            param.grad.data.add_(self.l2_norm_clip * self.noise_multiplier / self.minibatch_size * torch.randn_like(param.grad.data))
