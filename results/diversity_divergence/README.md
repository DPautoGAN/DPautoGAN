We tested the diversity divergence score (the lower, the better, with score = 0 if and only if the synthetic data exactly matches the original data in that feature_.
